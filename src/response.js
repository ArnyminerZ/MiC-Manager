 ...
 * @param {"missing-parameters","wrong-credentials","invalid-key","passwordless","invalid-request","max-attempts-reached","not-found","unauthorised",Error} code The error code to send.
